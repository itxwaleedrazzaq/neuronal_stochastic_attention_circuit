...
from idea10.deterministic_exps.baseline_cells import ContiFormer, ODEformer, OTTransformer
...
def run_episode(env, model):
    ...
    while True:
        ...
        try:
            pred, _ = model.predict(processed_obs, verbose=0)
        except:
        ...
        total_reward += np.squeeze(reward)
        steps += 1

        success = total_reward >= 860
