...
class Spiral:
    ...
    def build_nsac(self, d_model, num_heads, topk, sparsity,  ood_mean, ood_std, mc_sample):
        def model_fn():
    ...
    def evaluate(self, model):
        ...
        pred,_ = model.predict(t_full, verbose=0)
...
if __name__ == "__main__":
    ...
    BASE_CONFIG = {"d_model": 64, "num_heads": 4, "topk": 8, "sparsity": 0.5, "ood_mean": 0, "ood_std": 5, "mc_sample": 5}

    PARAM_SWEEPS = {
        "num_heads": [1, 2, 4, 8, 16, 32],
        "sparsity": [0.1, 0.3, 0.5, 0.7, 0.8, 0.9],
